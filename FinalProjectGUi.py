...
class BookManager:
    def __init__(self, master):
        ...
        self.button_add_phone = tk.Button(master, text="Add Phone Number", command=self.add_PhoneNum)
        ...
        self.button_add_phone.grid(row=9, column=0, columnspan=2, pady=10) #number of vertical spaces
